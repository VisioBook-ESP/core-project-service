...
export async function cleanDatabase(prisma: PrismaClient): Promise<void> {
  ...
  await prisma.$executeRawUnsafe(
    `DO $$ BEGIN TRUNCATE TABLE "Dialogue" CASCADE; EXCEPTION WHEN undefined_table THEN NULL; END $$`,
  );
  await prisma.$executeRawUnsafe(
    `DO $$ BEGIN TRUNCATE TABLE "Location" CASCADE; EXCEPTION WHEN undefined_table THEN NULL; END $$`,
  );
